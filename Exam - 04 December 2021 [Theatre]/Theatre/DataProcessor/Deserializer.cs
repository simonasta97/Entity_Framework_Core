namespace Theatre.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportPlays(TheatreContext context, string xmlString)
        {
            ...
            var models = XmlConverter.Deserializer<ImportPlayDto>(xmlString, "Plays");
        ...
        {
            var models = XmlConverter.Deserializer<ImportCastDto>(xmlString, "Casts");

            var casts=models.Select(x=>new Cast {
                FullName=x.FullName,
